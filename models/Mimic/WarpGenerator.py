...
class WarpGenerator(nn.Module):
    ...
    def create_layers(self):
        self.downscale_head = nn.Sequential(
            nn.Conv2d(3, 64, (4, 4), stride=4, padding=0),
            nn.ReLU(),
            nn.Conv2d(64, 64, (3, 3), stride=2, padding=1),
            nn.ReLU()
        )
        self.geo_conv1 = nn.Conv2d(64, 64, (9,9), stride=1, padding=4, dilation=1)
    ...
    def forward(self, tensorA):
        tensorA = self.downscale_head(tensorA)
        init_x1 = self.geo_conv1(tensorA)
